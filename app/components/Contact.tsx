export function Contact() {
  ...
  const CONTACT_EMAIL =
    import.meta.env.VITE_CONTACT_EMAIL ?? "andredelarovera@gmail.com";
  const GITHUB_URL =
    import.meta.env.VITE_GITHUB_URL ?? "https://github.com/Andre-D-Rez";

  const linkedinDisplay = (() => {
    try {
      const u = new URL(LINKEDIN_URL);
      const path = decodeURIComponent(u.pathname.replace(/^\//, ""));
      return `${u.host}/${path}`;
    } catch {
      return LINKEDIN_URL.replace(/^https?:\/\//, "");
    }
  })();
  ...
  const githubDisplay = (() => {
    try {
      ...
      return GITHUB_URL.replace(/^https?:\/\//, "");
    }
  })();
